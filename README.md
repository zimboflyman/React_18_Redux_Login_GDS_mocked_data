# GDS - mocked registration and login using React18 and redux
...
## About the XHIBIt Webportal

This is the base repo for the react frontend for the XHIBIT webportal. It uses:
